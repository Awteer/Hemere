...
def evaluate_eos_performance():
    ...
    # ここで add_physics_features が定義されているのでロード成功する
    ...
    fig.suptitle(f"Eos Model Evaluation Dashboard (XGBoost)\nR2={r2:.4f}, MAE={mae:.4f} kg/m", fontsize=16)

    # --- 1. Accuracy Check ---
    ax1 = fig.add_subplot(2, 2, 1)
    sc1 = ax1.scatter(y_test, y_pred, c=np.abs(rel_error), cmap='coolwarm', s=15, alpha=0.7, vmin=0, vmax=2)
